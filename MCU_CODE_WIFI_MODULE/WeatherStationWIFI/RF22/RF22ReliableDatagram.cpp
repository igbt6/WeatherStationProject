...
////////////////////////////////////////////////////////////////////
// Constructors
RF22ReliableDatagram::RF22ReliableDatagram(uint8_t thisAddress, uint8_t slaveSelectPin,uint8_t shutdownPin, uint8_t interruptPin)
    : RF22Datagram(thisAddress, slaveSelectPin,shutdownPin, interruptPin)
{
    _retransmissions = 0;
