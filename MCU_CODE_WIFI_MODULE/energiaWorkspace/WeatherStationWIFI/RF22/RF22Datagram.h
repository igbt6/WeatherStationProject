...
// $Id: RF22Datagram.h,v 1.5 2014/04/01 05:06:44 mikem Exp mikem $
...
public:
    ...
    RF22Datagram(uint8_t thisAddress, uint8_t slaveSelectPin, uint8_t shutdownPin, uint8_t interruptPin = 0);
