...
String location = "Krakow,pl"; // your desired location
...
void connectToServer() {
  ...
  if (client.connect(hostIp, 80)) {
    ...
    Serial.println("GET /data/2.5/weather?q="+location+"&mode=xml&units=metric");

    // make HTTP GET request to Facebook:
    client.println("GET /data/2.5/weather?q="+location+"&mode=xml&units=metric\n");
