...
#define LED_GRE_PRPH_BASE_ADDRESS  0x400FF000U
  
/*! Device data structure pointer used when auto initialization property is enabled. This constant can be passed as a first parameter to all component's methods. */
#define LED_GRE_DeviceData  ((LDD_TDeviceData *)PE_LDD_GetDeviceStructure(PE_LDD_COMPONENT_LED_GRE_ID))

/* Methods configuration constants - generated for all enabled component's methods */
#define LED_GRE_Init_METHOD_ENABLED    /*!< Init method of the component LED_GRE is enabled (generated) */
#define LED_GRE_GetVal_METHOD_ENABLED  /*!< GetVal method of the component LED_GRE is enabled (generated) */
#define LED_GRE_PutVal_METHOD_ENABLED  /*!< PutVal method of the component LED_GRE is enabled (generated) */
#define LED_GRE_ClrVal_METHOD_ENABLED  /*!< ClrVal method of the component LED_GRE is enabled (generated) */
#define LED_GRE_SetVal_METHOD_ENABLED  /*!< SetVal method of the component LED_GRE is enabled (generated) */
#define LED_GRE_NegVal_METHOD_ENABLED  /*!< NegVal method of the component LED_GRE is enabled (generated) */

/* Definition of implementation constants */
#define LED_GRE_MODULE_BASE_ADDRESS FPTA_BASE_PTR /*!< Name of macro used as the base address */
#define LED_GRE_PORTCONTROL_BASE_ADDRESS PORTA_BASE_PTR /*!< Name of macro used as the base address */
#define LED_GRE_PORT_MASK 0x00020000U  /*!< Mask of the allocated pin from the port */
