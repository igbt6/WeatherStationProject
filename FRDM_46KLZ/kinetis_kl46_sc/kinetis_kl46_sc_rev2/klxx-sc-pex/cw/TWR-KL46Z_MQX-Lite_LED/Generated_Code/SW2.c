...
} SW2_TDeviceData;                     /* Device data structure type */

typedef SW2_TDeviceData *SW2_TDeviceDataPtr ; /* Pointer to the device data structure. */

/* {MQXLite RTOS Adapter} Static object used for simulation of dynamic driver memory allocation */
static SW2_TDeviceData DeviceDataPrv__DEFAULT_RTOS_ALLOC;
/*
** ===================================================================
...
LDD_TDeviceData* SW2_Init(LDD_TUserData *UserDataPtr)
{
  ...
  SW2_TDeviceDataPtr DeviceDataPrv;
  ...
  PE_LDD_RegisterDeviceStructure(PE_LDD_COMPONENT_SW2_ID,DeviceDataPrv);
...
bool SW2_GetVal(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  portData = GPIO_PDD_GetPortDataInput(SW2_MODULE_BASE_ADDRESS) & SW2_PORT_MASK;
