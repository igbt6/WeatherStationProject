...
#define SW4_PRPH_BASE_ADDRESS  0x400FF000U
  
/*! Device data structure pointer used when auto initialization property is enabled. This constant can be passed as a first parameter to all component's methods. */
#define SW4_DeviceData  ((LDD_TDeviceData *)PE_LDD_GetDeviceStructure(PE_LDD_COMPONENT_SW4_ID))

/* Methods configuration constants - generated for all enabled component's methods */
#define SW4_Init_METHOD_ENABLED        /*!< Init method of the component SW4 is enabled (generated) */
#define SW4_GetVal_METHOD_ENABLED      /*!< GetVal method of the component SW4 is enabled (generated) */

/* Definition of implementation constants */
#define SW4_MODULE_BASE_ADDRESS FPTA_BASE_PTR /*!< Name of macro used as the base address */
#define SW4_PORTCONTROL_BASE_ADDRESS PORTA_BASE_PTR /*!< Name of macro used as the base address */
#define SW4_PORT_MASK 0x10U            /*!< Mask of the allocated pin from the port */
