...
} LED_RED_TDeviceData;                 /* Device data structure type */

typedef LED_RED_TDeviceData *LED_RED_TDeviceDataPtr ; /* Pointer to the device data structure. */
...
bool LED_RED_GetVal(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  portData = GPIO_PDD_GetPortDataOutput(LED_RED_MODULE_BASE_ADDRESS) & LED_RED_PORT_MASK;
...
void LED_RED_NegVal(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  GPIO_PDD_TogglePortDataOutputMask(LED_RED_MODULE_BASE_ADDRESS, LED_RED_PORT_MASK);
}
