...
/*
** ===================================================================
**     Method      :  RevB___read_console (component ConsoleIO)
**
**     Description :
**         __read_console
...
/*
** ===================================================================
**     Method      :  RevB___write_console (component ConsoleIO)
**
**     Description :
**         __write_console
**         This method is internal. It is used by Processor Expert only.
...
/*
** ===================================================================
**     Method      :  RevB___close_console (component ConsoleIO)
**
**     Description :
**         __close_console
**         This method is internal. It is used by Processor Expert only.
...
/*
** ===================================================================
**     Method      :  RevB__read (component ConsoleIO)
**
**     Description :
**         _read
**         This method is internal. It is used by Processor Expert only.
...
/*
** ===================================================================
**     Method      :  RevB__write (component ConsoleIO)
**
**     Description :
**         _write
**         This method is internal. It is used by Processor Expert only.
